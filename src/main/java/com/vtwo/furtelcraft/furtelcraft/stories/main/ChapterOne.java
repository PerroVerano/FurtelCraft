...
//        root.add(new WText(new TranslatableText("text.furtelcraft.mainplot.chapter1").setStyle(Style.EMPTY.withBold(true))), 10, -1, 5, 1);
//        root.add(new WText(new TranslatableText("text.furtelcraft.story.begin")
//                .setStyle(Style.EMPTY.withBold(true)
//                        .withColor(Formatting.GRAY)))
//                .setHorizontalAlignment(HorizontalAlignment.CENTER), 0, 0, 14, 1);
//        root.add(new WText(new TranslatableText("text.furtelcraft.mainplot.chapter1.page1")), 0, 1, 14, 10);
//        return root;
//    }
//
//    public static WGridPanel Page2() {
//        WGridPanel root = PageUtils.getDefaultGridPanel();
//        root.add(new WText(new TranslatableText("text.furtelcraft.mainplot.chapter1.page2").setStyle(Style.EMPTY.withBold(true)))
...
//        WGridPanel root = PageUtils.getDefaultGridPanel();
//        root.add(new WText(new TranslatableText("text.furtelcraft.mainplot.chapter1.page4.1")), 0, 0, 14, 10);
//        root.add(new WSprite(PAGE4), 0, 10, 13, 3);
//        root.add(new WText(new TranslatableText("text.furtelcraft.mainplot.chapter1.page4.2")), 0, 14, 14, 1);
//        return root;
//    }
//
