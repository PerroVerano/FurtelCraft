...
//
//    static {
//        STORY_MODE = new WCustomText(new TranslatableText("text.furtelcraft.content.storymode").setStyle(Style.EMPTY.withBold(true))).setHorizontalAlignment(HorizontalAlignment.CENTER);
//        MAIN_PLOT = new WCustomText(new TranslatableText("text.furtelcraft.content.storymode.mainplot"));
//        SIDING_PLOT = new WCustomText(new TranslatableText("text.furtelcraft.content.storymode.sidingplot"));
//        CHARACTER_PLOT = new WCustomText(new TranslatableText("text.furtelcraft.content.storymode.characterplot"));
//        WORLD_PLOT = new WCustomText(new TranslatableText("text.furtelcraft.content.storymode.worldplot"));
//
//        GUIDE_MODE = new WCustomText(new TranslatableText("text.furtelcraft.content.guidemode").setStyle(Style.EMPTY.withBold(true))).setHorizontalAlignment(HorizontalAlignment.CENTER);
//        MAKE_DNA = new WCustomText(new TranslatableText("text.furtelcraft.content.guidemode.makedna"));
//        MAKE_FURRIES_MOB = new WCustomText(new TranslatableText("text.furtelcraft.content.guidemode.makefurriesmob"));
//        CULTIVATE_FEELING = new WCustomText(new TranslatableText("text.furtelcraft.content.guidemode.cultivatefeeling"));
//        TRANSFUR = new WCustomText(new TranslatableText("text.furtelcraft.content.guidemode.transfur"));
//        MULTIBLOCK_STRUCTURE = new WCustomText(new TranslatableText("text.furtelcraft.content.guidemode.multiblockstructure"));
//
//    }
//
//    public int getStage() {
...
//
//        WText content = new WText(new TranslatableText("text.furtelcraft.content").setStyle(Style.EMPTY.withBold(true)));
