 ...
 */
public class ExitButtonWidget extends ButtonWidget {
    ...
    public ExitButtonWidget(int x, int y, int width, int height, int textureWidth, int textureHeight, Text message, PressAction onPress, TooltipSupplier tooltipSupplier, boolean isEnabled) {
