 ...
 */
public class HistButtonWidget extends ButtonWidget {
    ...
    public HistButtonWidget(int x, int y, int width, int height, int textureWidth, int textureHeight, Text message, PressAction onPress, TooltipSupplier tooltipSupplier, boolean isEnabled) {
