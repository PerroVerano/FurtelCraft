...
public class EditScreen extends Screen {
    ...
    private void updateInfo(MatrixStack matrices) {
        ...
        if (this.os1HistWidget.getState() == 0 && this.isEnabledHistTab) {
            if (this.nbtCompound == null || !this.nbtCompound.contains("OS1")) {
                this.textRenderer.drawWithShadow(matrices, Text.translatable("widget.furtelcraft.vn_edit_screen.hist.os1.empty"), iBase + 85, jBase + 40, 16777215);
            } else {
                this.textRenderer.drawWithShadow(matrices, Text.translatable("widget.furtelcraft.vn_edit_screen.hist.os1").append(this.nbtCompound.getString("OS1TEXT")), iBase + 85, jBase + 40, 16777215);
            }
        } else if (this.os2HistWidget.getState() == 0 && this.isEnabledHistTab) {
            if (this.nbtCompound == null || !this.nbtCompound.contains("OS2")) {
                this.textRenderer.drawWithShadow(matrices, Text.translatable("widget.furtelcraft.vn_edit_screen.hist.os2.empty"), iBase + 85, jBase + 40, 16777215);
            } else {
                this.textRenderer.drawWithShadow(matrices, Text.translatable("widget.furtelcraft.vn_edit_screen.hist.os2").append(this.nbtCompound.getString("OS2TEXT")), iBase + 85, jBase + 40, 16777215);
            }
        }
    }
    ...
    private void initWidgets() {
        ...
        this.DoneBtnWidget = new GButtonWidget(iBase + 212, jBase + 143, 36, 16, Text.translatable("widget.furtelcraft.vn_edit_screen_donebtn"), Color.WHITE, button -> this.saveInfo(), (widget, matrices, mouseX, mouseY) -> {
        });
        this.NextBtnWidget = new GButtonWidget(iBase + 172, jBase + 143, 36, 16, Text.translatable("widget.furtelcraft.vn_edit_screen_nextbtn"), Color.WHITE, button -> {
        ...
        this.DelBtnWidget = new GButtonWidget(iBase + 132, jBase + 143, 36, 16, Text.translatable("widget.furtelcraft.vn_edit_screen_delbtn"), Color.WHITE, button -> {
            if (this.isEnabledSingleLineTab) {
                if (!WordList.isEmpty()) {
                    this.count--;
        ...
        this.OS1FieldWidget = new TextFieldWidget(this.textRenderer, iBase + 85, jBase + 40, 130, 14, Text.translatable("widget.furtelcraft.vn_edit_screen.multiline.osfield"));
        this.OS2FieldWidget = new TextFieldWidget(this.textRenderer, iBase + 85, jBase + 40, 130, 14, Text.translatable("widget.furtelcraft.vn_edit_screen.multiline.osfield"));
        this.copyWordBtnWidget = new GButtonWidget(iBase + 219, jBase + 39, 28, 16, Text.translatable("widget.furtelcraft.vn_edit_screen.multiline.copybtn"), Color.WHITE,
                widget -> {
                ...
                (widget, matrices, mouseX, mouseY) -> this.renderTooltip(matrices, Text.translatable("widget.furtelcraft.vn_edit_screen.multiline.copybtn.tooltip"), mouseX, mouseY));
        ...
        this.singleHistWidget = new StripWidget(iBase + 85, jBase + 22, 54, 14, Text.translatable("widget.furtelcraft.vn_edit_screen.singleline"), Color.WHITE,
                widget -> {
                    ...
                    if (this.nbtCompound == null) {
                        this.histTextWidget.setMessage(Text.translatable("widget.furtelcraft.vn_edit_screen.hist.empty"));
                    } else {
                        this.sh = "";
                        ...
                        this.histTextWidget.setMessage(Text.literal(this.sh));
                    }
                },
                (widget, matrices, mouseX, mouseY) -> {
                },
                0);
        this.os1HistWidget = new StripWidget(iBase + 139, jBase + 22, 54, 14, Text.translatable("widget.furtelcraft.vn_edit_screen.multiline.os1strip"), Color.WHITE,
                widget -> {
                ...
                3);
        this.os2HistWidget = new StripWidget(iBase + 193, jBase + 22, 54, 14, Text.translatable("widget.furtelcraft.vn_edit_screen.multiline.os2strip"), Color.WHITE,
                widget -> {
        ...
        this.editBtnWidget = new GButtonWidget(iBase + 172, jBase + 143, 36, 16, Text.translatable("widget.furtelcraft.vn_edit_screen.hist.edit"), Color.WHITE,
                widget -> {
                ...
                (widget, matrices, mouseX, mouseY) -> this.renderTooltip(matrices, Text.translatable("widget.furtelcraft.vn_edit_screen.hist.edit.tooltip"), mouseX, mouseY));
    }
