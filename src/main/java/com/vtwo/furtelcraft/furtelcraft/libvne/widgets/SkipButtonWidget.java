...
public class SkipButtonWidget extends BasedWidget {
    ...
    public void renderWidget(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (this.isEnabled) {
            drawTexture(matrices, iIButton, jButton, 231, 64, iButtonWidth, ButtonHeight, textureWidth, textureHeight);
        } else {
            drawTexture(matrices, iIButton, jButton, 231, 75, iButtonWidth, ButtonHeight, textureWidth, textureHeight);
        }
