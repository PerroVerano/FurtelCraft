...
public class MagneticParticleProcessorScreen extends HandledScreen<ScreenHandler> {
    //GUI纹理路径
    private static final Identifier TEXTURE = new Identifier(MOD_ID,"textures/screen/mpp.png");

    public MagneticParticleProcessorScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
