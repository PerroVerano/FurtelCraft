...
import com.vtwo.furtelcraft.furtelcraft.screens.intedgui.BookSyncGUI;
...
public class ScreenInit {
    ...
    public static final ScreenHandlerType<BookSyncGUI> GUIDE_BOOK_SCREEN_HANDLER = new ScreenHandlerType<>((syncId, playerInventory) -> new BookSyncGUI(syncId, playerInventory, ScreenHandlerContext.EMPTY));
    ...
    public static void init() {
        ...
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(MOD_ID, "guide_book_screen_handler"), GUIDE_BOOK_SCREEN_HANDLER);
    }
}
