...
import com.vtwo.furtelcraft.furtelcraft.materials.SpecimenKnifeMaterial;
import com.vtwo.furtelcraft.furtelcraft.tools.SpecimenKnife;
...
public class ItemInit {
    ...
    public static final ItemGroup FC_ITEM_GROUP = FabricItemGroupBuilder.create(
            ...
            .appendItems(itemStacks -> {
                ...
                itemStacks.add(new ItemStack(ItemInit.WOLF_MEAT_SPECIMEN));
                itemStacks.add(new ItemStack(ItemInit.COOKED_WOLF_MEAT));
                itemStacks.add(new ItemStack(ItemInit.FOX_MEAT));
                itemStacks.add(new ItemStack(ItemInit.FOX_MEAT_SPECIMEN));
                itemStacks.add(new ItemStack(ItemInit.COOKED_FOX_MEAT));
                itemStacks.add(new ItemStack(ItemInit.ENDER_DRAGON_MEAT));
                itemStacks.add(new ItemStack(ItemInit.ENDER_DRAGON_MEAT_SPECIMEN));
                itemStacks.add(new ItemStack(ItemInit.COOKED_ENDER_DRAGON_MEAT));
